...
bash /home/tonjoo/dockerized-wordpress/wrapper.sh dev-local dev-tongkolspace down
bash /home/tonjoo/dockerized-wordpress/wrapper.sh dev-local dev-tongkolspace up -d 
